                        ...
                        <form method="post" action="${pageContext.request.contextPath}/profile" class="profile-form" enctype="multipart/form-data" data-profile-photo-form>
                            ...
                            <c:if test="${profile.role ne 'ADMIN'}"><c:choose>
                                <c:when test="${profile.academicInfoLocked}">
                                    ...
                                    <div class="locked-field">
                                        <span>${profile.semester le 7 ? 'Major' : 'Section'}</span>
                                ...
                                <c:otherwise>
                                    ...
                                    <div>
                                        <label for="sectionName" data-group-label>${profile.semester le 7 ? 'Major' : 'Section'}</label>
                            ...
                            <c:choose>
                                    ...
                                    <c:choose>
                                        <c:when test="${not empty profile.semester and not empty profile.sectionName}">
                                            <dl class="profile-details">
                                                ...
                                                <div><dt>${profile.semester le 7 ? 'Major' : 'Section'}</dt><dd><c:out value="${profile.sectionName}" /></dd></div>
                                ...
                                <c:otherwise>
                                    <dl class="profile-details">
                                        ...
                                        <div><dt>${profile.semester le 7 ? 'Major' : 'Section'}</dt><dd><c:choose><c:when test="${empty profile.sectionName}">Not assigned</c:when><c:otherwise><c:out value="${profile.sectionName}" /></c:otherwise></c:choose></dd></div>
                                    </dl>
                                </c:otherwise>
                            </c:choose>
                                    ...
                                    <c:choose>
                                        <c:when test="${not empty pendingAcademicRequest}">
                                            <div class="alert alert-info mt-3">
                                                <strong>Academic change request pending:</strong> Requested Semester <c:out value="${pendingAcademicRequest.requestedSemester}" />, ${pendingAcademicRequest.requestedSemester le 7 ? 'Major' : 'Section'} <c:out value="${pendingAcademicRequest.requestedSection}" />.
                                                ...
                                                <form method="post" action="${pageContext.request.contextPath}/profile/academic-change" class="profile-form mt-3">
                                                    ...
                                                    <div class="student-current-academic-card">
                                                        ...
                                                        <div class="student-current-academic-grid">
                                                            ...
                                                            <div class="student-current-academic-item">
                                                                <span class="item-label">Current ${profile.semester le 7 ? 'major' : 'section'}</span>
                                                    ...
                                                    <div class="mb-3">
                                                        <label class="form-label" for="reqSection" data-group-label>Requested ${profile.semester le 7 ? 'major' : 'section'}</label>

                                ...
                                <div class="academic-info-grid">
                                        ...
                                        <div class="box-values">
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    ...
                                                    <div>${item.oldSemester le 7 ? 'Major' : 'Section'}: <span><c:out value="${empty item.oldSection ? 'Not assigned' : item.oldSection}" /></span></div>
                                                </c:otherwise>
                                            </c:choose>
                                        </div>
                                    </div>
                                    <div class="academic-info-box requested-info">
                                        ...
                                        <div class="box-values">
                                            ...
                                            <div>${item.requestedSemester le 7 ? 'Major' : 'Section'}: <span><c:out value="${item.requestedSection}" /></span></div>
                                        </div>
                                    </div>
                                </div>

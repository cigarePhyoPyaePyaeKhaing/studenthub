...
<div class="dashboard-shell">
    ...
    <main class="feed-column">
        ...
        <nav class="dashboard-overview" aria-label="StudentHub sections"><a href="${pageContext.request.contextPath}/announcements"><span>A</span><strong>Announcements</strong><small>Academic updates</small></a><a href="${pageContext.request.contextPath}/deadlines"><span>D</span><strong>Deadlines</strong><small>Upcoming work</small></a><a href="${pageContext.request.contextPath}/discussions"><span>C</span><strong>Discussions</strong><small>Community chat</small></a><a href="${pageContext.request.contextPath}/notifications"><span>N</span><strong>Notifications</strong><small>Recent activity</small></a></nav>

...
<nav class="sidebar-content" aria-label="Primary navigation">
    ...
    <c:set var="adminDashboardActive" value="${currentPath eq '/admin'}" />
    <c:set var="adminUsersActive" value="${currentPath eq '/admin/users' or currentPath.startsWith('/admin/users/')}" />
    <c:set var="adminAcademicActive" value="${currentPath eq '/admin/academic-changes' or currentPath.startsWith('/admin/academic-changes/')}" />

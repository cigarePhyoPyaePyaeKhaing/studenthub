...
public final class AttachmentValidator {
    ...
    private static boolean signature(String type,String ext,byte[] b){
        ...
        if(type.equals("video/mp4"))return text(b,4,4).equals("ftyp"); if(type.equals("video/webm"))return starts(b,0x1a,0x45,0xdf,0xa3); if(type.equals("application/pdf"))return text(b,0,5).equals("%PDF-");

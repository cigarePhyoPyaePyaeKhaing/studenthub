...
public final class PrivateConversationPolicy{
 ...
 public static boolean shouldReappear(LocalDateTime deletedAt,LocalDateTime incomingAt){return deletedAt==null||incomingAt!=null&&incomingAt.isAfter(deletedAt);}
}
